...
// Note that our export statement includes default because this file will only have one function inside it - the reducer for our ticket list. That way, when we import the reducer into our test or anywhere else, we can store all the code directly inside a single variable such as ticketListReducer. (in test file)
